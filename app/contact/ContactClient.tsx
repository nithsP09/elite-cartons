            ...
            <div className="lg:col-span-2">
              <div className="p-8 rounded-lg border border-border bg-card">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  ...
                  >
                    <SelectTrigger
                      className="w-full h-10 px-4 py-2 rounded-lg border border-border bg-background text-foreground text-base focus:ring-2 focus:ring-accent focus:outline-none"
                    >
